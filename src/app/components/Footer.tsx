export default function Footer() {
  return (
    <footer className="bg-darkslategray flex md:flex-row flex-col items-center md:justify-start justify-center box-border text-left text-sm md:h-40 h-60 text-colour-main-grey-400 font-regular-14 md:space-x-10 space-x-0">
