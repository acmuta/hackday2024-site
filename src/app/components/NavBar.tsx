      ...
      <div className="flex flex-row items-start justify-center max-w-full text-left text-xl text-white font-iceland p-5 m-0">
        <div className=" flex items-start max-w-full justify-between md:space-x-80 md:space-y-0 space-y-4 md:flex-row flex-col">
          ...
          >
            <Link
              href="/form"
              className="cursor-pointer rounded-md w-[150px] hover:bg-zinc-400 pt-[7px] pb-[7px] bg-aliceblue rounded-8xs flex flex-row items-center justify-center border-[1px] border-solid border-white hover:bg-gainsboro-200 hover:bg-opacity-40 hover:scale-105 transition ease-in-out duration-100 "
            >
            ...
            <Link
              href="#faqSection"
              className="cursor-pointer rounded-md w-[150px] items-center justify-center hover:bg-zinc-400 pt-[7px] pb-[7px] pr-[62px] pl-[65px] bg-aliceblue rounded-8xs flex flex-row border-[1px] border-solid border-white hover:bg-gainsboro-200 hover:bg-opacity-40 hover:scale-105 transition ease-in-out duration-100 "
            >
              <div className="h-[37px] relative rounded-8xs bg-aliceblue box-border hidden border-[1px] border-solid border-white" />
              <div className="relative text-xl leading-[24px] font-iceland text-white text-left z-[1]">
                FAQ
            ...
            <Link
              href="#venueSection"
              className="cursor-pointer rounded-md w-[150px] items-center justify-center hover:bg-zinc-400 pt-[7px] pb-[7px] pr-[27px] pl-[34px] bg-aliceblue rounded-8xs flex flex-row border-[1px] border-solid border-white hover:bg-gainsboro-200 hover:bg-opacity-40 hover:scale-105 transition ease-in-out duration-100 "
            >
              <div className="h-[37px] relative rounded-8xs bg-aliceblue box-border hidden border-[1px] border-solid border-white" />
              <div className="relative text-xl leading-[24px] font-iceland text-white text-left z-[1]">
                LOCATION
